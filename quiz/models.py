...
class Quiz(models.Model):
    ...
    classe = models.ForeignKey(
        "school.Classe", on_delete=models.CASCADE, related_name="quizzes"
    )
    cours = models.ForeignKey(
        "school.Cours", on_delete=models.CASCADE, related_name="quizzes"
    )
...
class TakenQuiz(models.Model):
    student = models.ForeignKey(
        "student.Student", on_delete=models.CASCADE, related_name="taken_quizzes"
    )
...
class StudentAnswer(models.Model):
    student = models.ForeignKey(
        "student.Student", on_delete=models.CASCADE, related_name="quiz_answers"
    )
